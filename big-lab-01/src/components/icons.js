...
const iconPrivate = <svg className="bi bi-person-square" width="1.2em" height="1.2em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export { iconDelete, iconEdit, iconPrivate };